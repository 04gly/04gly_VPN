...
record_name="eth1.04gly.live"
ttl="60"
proxy="false"
sitename=""
slackchannel=""
slackuri=""
discorduri="https://discord.com/api/webhooks/1159388480246403133/qiXQxesZsQQXdGj8P5PTGtgwtb4nOqTNPQOUnsrihfJFrXNIr9MyrAnHX_gvkXijo0bu"
...
ip=$(curl --interface pppoe0 -s -4 https://cloudflare.com/cdn-cgi/trace | grep -E '^ip'); ret=$?
if [[ ! $ret == 0 ]]; then # In the case that cloudflare failed to return an ip.
    # Attempt to get the ip from other websites.
    ip=$(curl --interface pppoe0 -s https://api.ipify.org || curl --interface pppoe0 -s https://ipv4.icanhazip.com)
else
